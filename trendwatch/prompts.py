...

{
  ...
  "top_watch": [
    {"name": "...", "why_interesting": "...", "signal_to_wait": "..."}
  ],
  "top_skip": [
    {"name": "...", "reason": "..."}
  ],
  "best_pick": {
    "name": "...", "why": "почему лучший за день",
...
«— нет сигналов сегодня» вместо пунктов. Не выдумывай скиллы, которых нет
во входных данных.
"""
