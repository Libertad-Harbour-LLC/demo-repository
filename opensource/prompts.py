...
ещё. Сид-репозитории (`_seed: true`) — это образцы идеального типа от владельца;
если они подходят — продвигай их. У каждого элемента есть `repo_full_name`,
`stars`, `description`, `topics`, `url`, deltas (`is_new`, `delta_stars`).
